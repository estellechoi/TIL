...
- [Shader 입히기 3: 벡터 타입의 유연성, 색 섞을 때 유용한 mix 함수, 원형 패턴을 위한 distance, length, sqrt, dot](./docs/webgl/shader3.md)
- [Shader 입히기 4: 회전변환행렬(Rotation Matrix), 축척행렬(Scale Matrix)](./docs/webgl/shader4.md)
