...
> [수출 규정 준수 요구 사항 결정](https://help.apple.com/app-store-connect/#/dev63c95e436) 문서를 참고하여, 내 앱이 미국 수출법 면제 대상에 해당하는지 조금 더 세밀하게 살펴볼 수 있습니다. `앱 내 추가 기능` 탭을 클릭하고 왼쪽 사이드바의 `암호화` 메뉴로 이동한 후, iOS 관련 문서 섹션의 `+` 버튼을 클릭, 나타난 질문들에 차례로 답합니다.
