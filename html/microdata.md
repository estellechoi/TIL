...
이 글은 마이크로데이터 위주로 설명되어 있지만, schema.org 사이트의 대부분의 예제가 RDFa, JSON-LD 내용을 포함하고 있으니 참고하세요. 이 글에서 소개하는 (`types`, `properties` 등의) 기본적인 개념들은 마이크로데이터 외에도 적용할 수 있습니다. 예제에서 여러 방법을 비교하는 내용을 확인해보세요.
